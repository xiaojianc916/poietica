...
pub async fn settings_set(app: AppHandle, settings: AppSettings) -> SettingsCommandResult<()> {
    ...
    crate::ipc::commands::conversation::runtime::apply_daemon_intent(&app, saved.general.daemon)
        .await;
...
pub async fn settings_reset(app: AppHandle) -> SettingsCommandResult<AppSettings> {
    ...
    crate::ipc::commands::conversation::runtime::apply_daemon_intent(&app, defaults.general.daemon)
        .await;
